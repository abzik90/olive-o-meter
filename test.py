...
if __name__ == "__main__":
    ...
    #for i in range(1,6):
    #    manager.createReading(sample_time='2023-10-09 12:00:00', nm_525_ON=100*i, nm_525_OFF=200*i,
    ...
    #manager.updateReading(reading_id=2, sample_time='2023-10-10 14:00:00', nm_525_ON=110, nm_525_OFF=220,
    ...
    # manager.deleteReading(1)
    print(OliveReadingsManager.getLastReadingId())
